        ...
        $(document).ready(function(){
            ...
            $(document).on("click",'div.verpakking li',function(){          // deze is ingewikkeld geweest omdat ik hier zit met het toevoegen en verwijderen van 2 bollen
                ...
                if (tellerbollen < tellerTotaalmax) {
                    ...
                    {
                        $("div.bollen li img[alt='foto2']").show();         // ... als het al eens aangeklikt is geweest, en ze vooor de zoveelste keer van keuze veranderen dan moet ik ze enkel terug toneen
                    }
                    tellerbollen += 2
                }}
